        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "Yasuki-MD~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *Yasuki-MD Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by DillaCodeX\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/DillaCodeX/Yasuki-MD\n` +
                            `▸ https://www.whatsapp.com/channel/0029Vb5ZBnkFHWq24cuKkf04`,
                        contextInfo: {
                            mentionedJid: [sock.user.id],
                            forwardingScore: 1000,
                            isForwarded: true,
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: "120363414613628494@newsletter",
                                newsletterName: "DillaCodeX",
                                serverMessageId: 143
                            }
                        }
                    };
